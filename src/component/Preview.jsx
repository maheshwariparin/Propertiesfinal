...
const GotoAdmin=()=>{
    ...
    >
      {buttonStatus}
         ...
         onClick={() => setStage((prev) => prev - 1)}
            ...
            className="px-6 py-2 bg-blue-500 text-white rounded-2xl hover:bg-gray-600 transition"
          >
            Previous
          </button>
  ...
  return (
    <div className="p-6 w-full bg-white rounded-xl mt-0">
           <div className="w-full h-[100px] bg-white p-4 flex items-center border-b border-gray-500">
  <div className="flex-1">
    <div className="ml-25 text-3xl w-[300px] font-bold text-gray-500">
      {listingType?.toLowerCase() === "sell" ? (
        <>
          ₹{formatPrice(expectedPrice)}
          {pricePerSqFt && (
  ...
  <div className="flex-1 border-l pl-4 ml-0 mr-80 text-gray-500">
    <div className="text-2xl font-semibold">
      {propertyCategory === "commercial" ? (
        <>
          {bedrooms > 1 ? `${bedrooms} Working Space Rooms` : `Full Space Office`}
  ...
  <button
    ...
    >
      ...
      {propertyCategory === "commercial" ? (
        <>
          <FaBuilding /> {bedrooms > 1 ? `${bedrooms} Working Space Rooms` : `Full Space Office`}
        </>
      ) : (
        <>
  ...
  <span className="">
    ...
    <div className="flex items-center gap-2"><FaDoorOpen /> {houseStatus}</div>
              </div>
              <h3 className="mt-6 text-lg font-semibold text-gray-700">Summary</h3>
